import 'server-only';
import type { Account, FraudAlert, StrCtrReport, Transaction } from './types';
...
<goAML>
  <report>
    ...
    <action_initiated>
      ...
      <comment>${escapeXml(report.narrative || 'Suspicious activity detected by Causeway AI system. Under investigation.')}</comment>
    </action_initiated>
  </report>
</goAML>`;
}